...
ARCHITECTURE structure OF SubtratorCompleto IS
...
-- Equation(s):
-- \inst1~combout\ = ( \Cin~input_o\ & ( !\A~input_o\ $ (\B~input_o\) ) ) # ( !\Cin~input_o\ & ( !\A~input_o\ $ (!\B~input_o\) ) )
...
-- Equation(s):
-- \inst6~0_combout\ = ( \Cin~input_o\ & ( (!\A~input_o\) # (\B~input_o\) ) ) # ( !\Cin~input_o\ & ( (!\A~input_o\ & \B~input_o\) ) )
