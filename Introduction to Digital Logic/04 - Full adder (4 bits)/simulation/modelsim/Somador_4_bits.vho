...
-- Equation(s):
-- \inst1|inst1~combout\ = ( \B1~input_o\ & ( !\A1~input_o\ $ (((\A0~input_o\ & \B0~input_o\))) ) ) # ( !\B1~input_o\ & ( !\A1~input_o\ $ (((!\A0~input_o\) # (!\B0~input_o\))) ) )
...
-- Equation(s):
-- \inst2|inst1~combout\ = ( \A0~input_o\ & ( \B1~input_o\ & ( !\B2~input_o\ $ (!\A2~input_o\ $ (((\B0~input_o\) # (\A1~input_o\)))) ) ) ) # ( !\A0~input_o\ & ( \B1~input_o\ & ( !\B2~input_o\ $ (!\A1~input_o\ $ (\A2~input_o\)) ) ) ) # ( \A0~input_o\ & ( 
...
-- Equation(s):
-- \inst1|inst3~0_combout\ = ( \A0~input_o\ & ( \B1~input_o\ & ( (\B0~input_o\) # (\A1~input_o\) ) ) ) # ( !\A0~input_o\ & ( \B1~input_o\ & ( \A1~input_o\ ) ) ) # ( \A0~input_o\ & ( !\B1~input_o\ & ( (\A1~input_o\ & \B0~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000011001100110011001100110011001111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_A1~input_o\,
...
-- Equation(s):
-- \inst3|inst1~combout\ = ( \inst1|inst3~0_combout\ & ( !\B3~input_o\ $ (!\A3~input_o\ $ (((\A2~input_o\) # (\B2~input_o\)))) ) ) # ( !\inst1|inst3~0_combout\ & ( !\B3~input_o\ $ (!\A3~input_o\ $ (((\B2~input_o\ & \A2~input_o\)))) ) )
...
PORT MAP (
	...
	dataf => \inst1|ALT_INV_inst3~0_combout\,
	combout => \inst3|inst1~combout\);

-- Location: MLABCELL_X34_Y2_N21
\inst3|inst3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|inst3~0_combout\ = ( \inst1|inst3~0_combout\ & ( (!\B3~input_o\ & (\A3~input_o\ & ((\A2~input_o\) # (\B2~input_o\)))) # (\B3~input_o\ & (((\A2~input_o\) # (\A3~input_o\)) # (\B2~input_o\))) ) ) # ( !\inst1|inst3~0_combout\ & ( (!\B3~input_o\ & 
-- (\B2~input_o\ & (\A3~input_o\ & \A2~input_o\))) # (\B3~input_o\ & (((\B2~input_o\ & \A2~input_o\)) # (\A3~input_o\))) ) )
