...
ENTITY 	subtrator_4_bits_com_complemento_de_2 IS
    PORT (
	S0 : OUT std_logic;
	A0 : IN std_logic;
	B0 : IN std_logic;
...
END subtrator_4_bits_com_complemento_de_2;
...
-- OPERACAO	=>  Location: PIN_AB13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF subtrator_4_bits_com_complemento_de_2 IS
...
-- Equation(s):
-- \inst1|inst1~0_combout\ = !\B0~input_o\ $ (!\A0~input_o\)
...
\inst|inst1\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst|inst1~combout\ = ( \B1~input_o\ & ( !\A1~input_o\ $ (((\B0~input_o\ & (!\A0~input_o\ $ (!\OPERACAO~input_o\))))) ) ) # ( !\B1~input_o\ & ( !\A1~input_o\ $ (((!\B0~input_o\) # (!\A0~input_o\ $ (\OPERACAO~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001010011101011000101001110101111101011000101001110101100010100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_B0~input_o\,
	datab => \ALT_INV_A0~input_o\,
	datac => \ALT_INV_OPERACAO~input_o\,
...
-- Equation(s):
-- \inst|inst3~0_combout\ = ( \B1~input_o\ & ( (!\A0~input_o\ & (\A1~input_o\ & ((!\OPERACAO~input_o\) # (!\B0~input_o\)))) # (\A0~input_o\ & (((!\OPERACAO~input_o\ & \B0~input_o\)) # (\A1~input_o\))) ) ) # ( !\B1~input_o\ & ( (!\A0~input_o\ & 
-- (\OPERACAO~input_o\ & ((!\B0~input_o\) # (\A1~input_o\)))) # (\A0~input_o\ & (((\B0~input_o\ & \A1~input_o\)) # (\OPERACAO~input_o\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000100110111001100010011011100000100111111010000010011111101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_A0~input_o\,
	datab => \ALT_INV_OPERACAO~input_o\,
...
-- Equation(s):
-- \inst2|inst1~combout\ = ( \A2~input_o\ & ( !\OPERACAO~input_o\ $ (!\inst|inst3~0_combout\ $ (!\B2~input_o\)) ) ) # ( !\A2~input_o\ & ( !\OPERACAO~input_o\ $ (!\inst|inst3~0_combout\ $ (\B2~input_o\)) ) )
...
PORT MAP (
	datab => \ALT_INV_OPERACAO~input_o\,
	datac => \inst|ALT_INV_inst3~0_combout\,
...
-- Equation(s):
-- \inst3|inst1~combout\ = ( \A3~input_o\ & ( \inst|inst3~0_combout\ & ( !\B3~input_o\ $ (((!\A2~input_o\ & ((\B2~input_o\))) # (\A2~input_o\ & (!\OPERACAO~input_o\)))) ) ) ) # ( !\A3~input_o\ & ( \inst|inst3~0_combout\ & ( !\B3~input_o\ $ (((!\A2~input_o\ & 
-- ((!\B2~input_o\))) # (\A2~input_o\ & (\OPERACAO~input_o\)))) ) ) ) # ( \A3~input_o\ & ( !\inst|inst3~0_combout\ & ( !\B3~input_o\ $ (((!\A2~input_o\ & (\OPERACAO~input_o\)) # (\A2~input_o\ & ((\B2~input_o\))))) ) ) ) # ( !\A3~input_o\ & ( 
-- !\inst|inst3~0_combout\ & ( !\B3~input_o\ $ (((!\A2~input_o\ & (!\OPERACAO~input_o\)) # (\A2~input_o\ & ((!\B2~input_o\))))) ) ) )
...
PORT MAP (
	...
	dataf => \inst|ALT_INV_inst3~0_combout\,
	combout => \inst3|inst1~combout\);

-- Location: LABCELL_X36_Y9_N48
\inst3|inst3~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \inst3|inst3~0_combout\ = ( \A3~input_o\ & ( \inst|inst3~0_combout\ & ( ((!\B3~input_o\ & ((\B2~input_o\) # (\OPERACAO~input_o\))) # (\B3~input_o\ & ((!\OPERACAO~input_o\) # (!\B2~input_o\)))) # (\A2~input_o\) ) ) ) # ( !\A3~input_o\ & ( 
-- \inst|inst3~0_combout\ & ( (!\B3~input_o\ & (\OPERACAO~input_o\ & ((!\B2~input_o\) # (\A2~input_o\)))) # (\B3~input_o\ & (!\OPERACAO~input_o\ & ((\B2~input_o\) # (\A2~input_o\)))) ) ) ) # ( \A3~input_o\ & ( !\inst|inst3~0_combout\ & ( (!\B3~input_o\ & 
-- (((\A2~input_o\ & \B2~input_o\)) # (\OPERACAO~input_o\))) # (\B3~input_o\ & ((!\OPERACAO~input_o\) # ((\A2~input_o\ & !\B2~input_o\)))) ) ) ) # ( !\A3~input_o\ & ( !\inst|inst3~0_combout\ & ( (\A2~input_o\ & ((!\B3~input_o\ & (\OPERACAO~input_o\ & 
-- !\B2~input_o\)) # (\B3~input_o\ & (!\OPERACAO~input_o\ & \B2~input_o\)))) ) ) )
